# Contributing to ngx-auth

We would love for you to contribute to **`ngx-auth`** and help make it even better than it is today! As a contributor,
...
Help us keep **`ngx-auth`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `ngx-auth:master`.
