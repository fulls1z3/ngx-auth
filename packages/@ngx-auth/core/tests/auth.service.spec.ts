...
describe('@ngx-auth/core:', () => {
  ...
  describe('AuthService', () => {
    ...
    it('is defined', inject([AuthService], (auth: AuthService) => {
      expect(AuthService).toBeDefined();
      expect(auth).toBeDefined();
      expect(auth instanceof AuthService).toBeTruthy();
    }));

    it('should be able to return the `defaultUrl`', inject([AuthService], (auth: AuthService) => {
      const res = auth.defaultUrl;
      expect(res).toEqual('');
    }));

    it('should be able to authenticate w/valid combination', inject([AuthService], (auth: AuthService) => {
      const fixture = TestBed.createComponent(TestBootstrapComponent);
      fixture.detectChanges();

      auth.authenticate('valid', 'valid').subscribe(res => {
    ...
    it('should not authenticate w/o valid combination', inject([AuthService], (auth: AuthService) => {
      const fixture = TestBed.createComponent(TestBootstrapComponent);
      fixture.detectChanges();

      auth.authenticate('invalid', 'invalid').subscribe(res => {
