      ...
      () => {
        it('should be able to provide `Auth0StaticLoader`',
          () => {
            ...
            expect(Auth0StaticLoader)
              .toBeDefined();
            expect(auth.loader)
              .toBeDefined();
            expect(auth.loader instanceof Auth0StaticLoader)
              .toBeTruthy();
          });
        ...
        it('should be able to return the default auth0Settings',
          () => {
            ...
            expect(loader.backend.domain)
              .toEqual('');
            expect(loader.backend.clientID)
              .toEqual('');
            expect(loader.backend.scope)
              .toEqual('openid');
            expect(loader.backend.responseType)
              .toEqual('token id_token');
            ...
            expect(loader.loginRoute)
              .toEqual(testSettings.publicRoute);
            expect(loader.publicRoute)
              .toEqual(testSettings.publicRoute);
